...
def start(message):
    ...
    if not check_join(user_id):
        ...
        bot.send_message(user_id, "স্বাগতম মামা! আপনি এখন বটের মূল মেনু ব্যবহার করতে পারবেন।", reply_markup=main_menu())
...
def verify(call):
    ...
    if check_join(user_id):
        ...
        if res and res[0]:
            ...
            conn.commit()
            try:
                bot.send_message(ref_id, "মামা! আপনার রেফার লিংকে একজন জয়েন করেছে। আপনি ১০ টাকা বোনাস পেয়েছেন।")
            except: pass
        ...
        bot.answer_callback_query(call.id, "মামা, আগে চ্যানেলে জয়েন করুন!", show_alert=True)
