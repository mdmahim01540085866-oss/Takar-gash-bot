...
def start(message):
    ...
    if not is_joined(user_id):
        ...
        bot.send_message(user_id, "স্বাগতম মামা! ১০ টাকা বোনাস পেতে আগে চ্যানেলে জয়েন করো, তারপর ভেরিফাই বাটনে ক্লিক করো।", reply_markup=m)
    else:
...
def verify(call):
    ...
    if is_joined(user_id):
        ...
        bot.answer_callback_query(call.id, "আগে চ্যানেলে জয়েন করো মামা!", show_alert=True)
...
def handle_text(message):
    ...
    if message.text == "💰 ব্যালেন্স":
        ...
        if balance < 1000:
            ...
            bot.send_message(user_id, "মামা, ১০০০ টাকা হয়ে গেছে! তোমার বিকাশ/নগদ নাম্বারটা দাও।")
